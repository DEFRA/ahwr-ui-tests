...
describe("Multiple herds dairy cattle claim journeys when poultry is switched on", async function () {
  ...
  it("can create a PI hunt follow-up claim for an approved dairy review claim with positive test result", async () => {
    ...
    await createMultipleHerdDairyFollowUpForFirstHerd({ isPoultryEnabled: true });
