...
export const CONTINUE_YOUR_CLAIM = 'a[href*="/livestock/biosecurity-assessment"]';
...
export const MANAGE_YOUR_CLAIMS_LINK = 'a[href*="/livestock/manage-claims"]';

export const EXTERNAL_GOV_LINK = '.govuk-link[rel="external"]';

export const DATE_OF_VISIT_GO_BACK_LINK = '.govuk-link[href="/livestock/date-of-visit"]';
