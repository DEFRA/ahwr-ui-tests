...
// Poultry-specific selectors
export const SITE_NAME = "#herdName";

export const SITE_CPH = "#herdCph";

export const SITE_OTHERS_ON_SBI_YES = "#isOnlyHerdOnSbi";

export const SITE_OTHERS_ON_SBI_NO = "#isOnlyHerdOnSbi-2";
