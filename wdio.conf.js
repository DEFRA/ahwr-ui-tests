...
export const config = {
  ...
  suites: {
    ...
    poultry: [
      ...
      "./test/specs/poultrySuite/test.review-claim-before-mh-launch.journeys.js",
      "./test/specs/poultrySuite/test.follow-up-claim-before-mh-launch.journeys.js",
      "./test/specs/poultrySuite/test.pre.mh.journeys.js",
      "./test/specs/poultrySuite/test.pre.and.post.mh.journeys.js",
      "./test/specs/poultrySuite/test.beef.journeys.js",
      "./test/specs/poultrySuite/test.dairy.journeys.js",
      "./test/specs/poultrySuite/test.pigs.journeys.js",
      "./test/specs/poultrySuite/test.sheep.journeys.js",
