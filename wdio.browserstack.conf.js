...
export const config = {
  ...
  baseUrl: `https://ahwr-ui-tests.${process.env.ENVIRONMENT}.cdp-int.defra.cloud`,
  ...
  commonCapabilities: {
    'bstack:options': {
      buildName: `ahwr-ui-tests-${process.env.ENVIRONMENT}` // configure as required
    }
  },
    ...
    [
      'browserstack',
      {
        ...
        testObservabilityOptions: {
          ...
          buildName: `ahwr-ui-tests-${process.env.ENVIRONMENT}`
        },
